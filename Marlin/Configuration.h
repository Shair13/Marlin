...
#define STRING_CONFIG_H_AUTHOR "(Szer13, Sapphire Pro)" // Who made the changes.
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 26.36
  #define DEFAULT_bedKi 4.98
  #define DEFAULT_bedKd 98.99
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 2), (Y_MAX_POS / 2), 10 }
